...
var TemplateCompiler = (function () {
    ...
    TemplateCompiler.prototype.compileTemplatesCodeGen = function (components) {
        ...
        collection_1.ListWrapper.forEachWithIndex(componentMetas, function (compMeta, index) {
            ...
            var compiledTemplateExpr = constructionKeyword + " " + command_compiler_1.TEMPLATE_COMMANDS_MODULE_REF + "CompiledComponentTemplate('" + templateId + "'," + templateArguments[index].join(',') + ")";
            var variableValueExpr;
            if (compMeta.type.isHost) {
                variableValueExpr =
                    constructionKeyword + " " + command_compiler_1.TEMPLATE_COMMANDS_MODULE_REF + "CompiledHostTemplate(" + compiledTemplateExpr + ")";
            }
            else {
